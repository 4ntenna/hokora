...
Pure presentation — opened by ``i`` in Discovery, snapshots identity,
transport, and trust state. Reads only client-local state and
``RNS.Transport``; no wire fields, no daemon coordination.
"""
