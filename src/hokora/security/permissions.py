...
class PermissionResolver:
    ...
    async def _get_everyone_role(self, role_repo: RoleRepo):
        """Fresh-query @everyone so runtime perm changes apply immediately."""
    ...
    async def get_effective_permissions(
        ...
        # Aggregate allow/deny first so the result is order-independent.
        ...
        # Write-restricted: role-less users get read-only (strip write from @everyone baseline).
