...
class IdentityManager:
    ...
    def get_signing_public_key(self) -> bytes:
        """Return the 32-byte Ed25519 signing pubkey for the federation wire.

        Use this everywhere a peer_public_key field goes onto the wire —
        never RNS.Identity.get_public_key() (which is 64 bytes
        X25519+Ed25519 concatenated and would fail verifier length checks).
        """
